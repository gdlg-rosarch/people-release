Name:           ros-indigo-people-velocity-tracker
Version:        1.0.10
Release:        0%{?dist}
...
Requires:       ros-indigo-easy-markers
Requires:       ros-indigo-geometry-msgs
Requires:       ros-indigo-kalman-filter
Requires:       ros-indigo-leg-detector
Requires:       ros-indigo-people-msgs
Requires:       ros-indigo-roslib
Requires:       ros-indigo-rospy
BuildRequires:  ros-indigo-catkin
BuildRequires:  ros-indigo-easy-markers
BuildRequires:  ros-indigo-geometry-msgs
BuildRequires:  ros-indigo-kalman-filter
